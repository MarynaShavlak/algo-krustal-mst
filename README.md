...
![Крок із циклом: код, граф, структура DSU](images/dsu_3panel_cycle.png)
...
│   ├── has_path_steps.png       # §6: 13 панелей [код | граф] (лекційний варіант)
...
└── src/
    └── kruskal_mst/
        ...
        └── viz/
            ...
            ├── has_path_steps.py # 13 панелей лекційного варіанту (§6)
