...
def spanning_tree_example():
    ...
    nx.draw_networkx_nodes(G, POS, ax=ax1, node_size=900, node_color="#A8D8EA",
                           edgecolors="#2C6E8F", linewidths=1.8)
    nx.draw_networkx_labels(G, POS, ax=ax1, font_size=14, font_weight="bold", font_color="#15384A")
    nx.draw_networkx_edges(G, POS, ax=ax1, width=2.2, edge_color="#9AA0A6")
    ...
    nx.draw_networkx_nodes(T, POS, ax=ax2, node_size=900, node_color="#A8D8EA",
                           edgecolors="#2C6E8F", linewidths=1.8)
    ...
    nx.draw_networkx_edges(G, POS, ax=ax2, edgelist=non_tree, width=1.8,
                           edge_color="#D9D9D9", style="dashed")
    nx.draw_networkx_edges(T, POS, ax=ax2, edgelist=tree_edges, width=3.4, edge_color="#2E8B57")
